...
export const services = [
  {
    ...
    para: "I develop modern, responsive, and high-performance web applications using the MERN stack  ensuring seamless frontend-backend integration."
  },
  {
    id: "02",
    icon: <FaDatabase />,
  ...
  },
  {
    ...
    para: "Deploy and manage full-stack applications on platforms like Vercel and Render, with proper domain setup, and environment configurations for production."
  },
  {
    id: "04",
    icon: <FaBug />,
